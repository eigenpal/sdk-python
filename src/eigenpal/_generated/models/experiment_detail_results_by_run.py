...
T = TypeVar("T", bound="ExperimentDetailResultsByRun")
...
class ExperimentDetailResultsByRun:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        experiment_detail_results_by_run.additional_properties = additional_properties
        return experiment_detail_results_by_run
