...
from ..models.dataset_review_request_status import DatasetReviewRequestStatus
...
T = TypeVar("T", bound="DatasetReviewRequest")
...
class DatasetReviewRequest:
    """
        Attributes:
            ...
            status (DatasetReviewRequestStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = DatasetReviewRequestStatus(d.pop("status"))
