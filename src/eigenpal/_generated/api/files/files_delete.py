...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/v1/files/{id}".format(id=quote(str(id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ApiErrorEnvelope | DeleteFileResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ApiErrorEnvelope | DeleteFileResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorEnvelope | DeleteFileResponse
     """
