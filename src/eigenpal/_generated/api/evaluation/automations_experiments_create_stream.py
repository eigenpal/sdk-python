...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/automations/{id}/experiments/stream".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Create automation experiment with NDJSON progress
     ...
     Starts a batch eval experiment for workflow or agent automations and streams per-run completion
    events as NDJSON.
