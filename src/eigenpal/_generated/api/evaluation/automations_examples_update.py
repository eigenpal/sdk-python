...
from ...models.dataset_example_update import DatasetExampleUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/automations/{id}/examples/{example_id}".format(id=quote(str(id), safe=""),example_id=quote(str(example_id), safe=""),),
    }
