...
T = TypeVar("T", bound="WorkflowRunExecutionExpected")



@_attrs_define
class WorkflowRunExecutionExpected:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_run_execution_expected = cls(
            output=output,
            files=files,
        )

        return workflow_run_execution_expected
