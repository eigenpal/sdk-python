...
from ...models.create_dataset_review_request import CreateDatasetReviewRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ApiErrorEnvelope | DatasetReviewDetail | None:
    if response.status_code == 201:
        response_201 = DatasetReviewDetail.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """ Create dataset review request
     ...
     Snapshot selected dataset examples into a review request. Include instructions, focusFields to
    highlight, and ignoredFields for paths reviewers can skip. Optional itemNotes become commented
    events on those examples.
