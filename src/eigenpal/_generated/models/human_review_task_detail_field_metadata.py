...
T = TypeVar("T", bound="HumanReviewTaskDetailFieldMetadata")
...
class HumanReviewTaskDetailFieldMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        human_review_task_detail_field_metadata.additional_properties = additional_properties
        return human_review_task_detail_field_metadata

    @property
    def additional_keys(self) -> list[str]:
        return list(self.additional_properties.keys())

    def __getitem__(self, key: str) -> HumanReviewTaskDetailFieldMetadataAdditionalProperty:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: HumanReviewTaskDetailFieldMetadataAdditionalProperty) -> None:
